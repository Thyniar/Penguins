...
<html>
    ...
    <body class="landing">
        ...
        <section id="banner">
            ...
            <p>Realize your children's dreams !</p>
            <br>
            <a href="#" class="btn btn-primary btn-lg">Get Your Penguin</a>
        </section>

        <div class="container col-lg-12" id="one">
            <div class="row">
                <h3>Insert your text here</h3>
                <div class="col-lg-4">
                    <i class="icon big rounded fa-snowflake-o"></i>
                </div>
                <div class="col-lg-4">
                    <i class="icon big rounded fa-shopping-cart"></i>
                </div>
                <div class="col-lg-4">
                    <i class="icon big rounded fa-plane"></i>
                </div>
